...
(house-of-ai-representatives)[https://house-of-ai-representatives.com]
...
- **Dual AI Interface**: Access both Gemini and Azure OpenAI simultaneously in a split-screen layout
...
2. You'll see two panels:
   ...
   - Right panel: Azure OpenAI (Copilot)
...
- Integrates with Google's Generative AI SDK and Azure OpenAI API
